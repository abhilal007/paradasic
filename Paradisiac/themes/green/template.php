 ...
 */
function green_html_head_alter(&$head_elements) {
 ...
 */
function green_process_page(&$variables) {
...
function green_page_alter($page) {
...
function green_breadcrumb($variables) {
...
if (theme_get_setting('responsive_menu_state')) {
	...
	drupal_add_js(drupal_get_path('theme', 'green') .'/js/jquery.mobilemenu.js');
